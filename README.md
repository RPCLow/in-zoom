...
#### Обьясняю как жто работает. Когда вы сохраняете файл в Telegram, он сохраняется в начальной папке Downloads/Telegram, а когда вы скачиваете файл через Браузер, файл находится в начальной папке Downloads, по этому мы переходим в папку Telegram, достаем от туда наши настройки, затем извлекаем их в ту же папку, где у нас лежит скрипт, то есть Downloads.
